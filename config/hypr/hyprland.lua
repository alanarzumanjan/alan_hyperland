...
local ai = "claude-desktop"
local note = "obsidian"
local messenger = "flatpak run org.telegram.desktop"
...
hl.env("XCURSOR_THEME", "catppuccin-mocha-rosewater-cursors")
...
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd("hyprctl dispatch pin active"))
hl.bind(mainMod .. " + TAB", hl.dsp.exec_cmd("hyprctl dispatch cyclenext next"))
...
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("/data/alan_home_ext/alan_hyperland/bin/brightness --up"),   { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("/data/alan_home_ext/alan_hyperland/bin/brightness --down"), { locked = true, repeating = true })
