...
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("/data/alan_hyperland/bin/brightness --up"),   { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("/data/alan_hyperland/bin/brightness --down"), { locked = true, repeating = true })
